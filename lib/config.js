...
function parameterConfig() {
    return {
        ...
        lang: Joi.string().alphanum().optional().description('Language for the output, should be the two-letter abbreviation (e.g. `de`).')
    };
}
    ...
    return [
        {
            ...
            params: [ 'zip', 'station', 'start', 'end', 'sort', 'limit', 'lang' ]
        },
        {
            ...
            params: [ 'zip', 'start', 'end', 'sort', 'limit', 'lang' ]
        },
        {
