        ...
        config: {
            ...
            validate: {
                query: {
                    ...
                    start: Joi.any().description('Start of date range, this could either be a date or an exprssion like `yesterday`'),
                    end: Joi.any().description('End of date range, this could either be a date or an exprssion like `next Monday`'),
